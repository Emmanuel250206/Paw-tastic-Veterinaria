error id: file://<WORKSPACE>/src/main/java/com/mycompany/aplicacion/persistencia/Conexion.java:java/sql/DriverManager#getConnection(+1).
...
public class Conexion {
    ...
    public Connection estableceConexion() {
        try {
            ...
            conectar = DriverManager.getConne@@ction(cadena, usuario, contrasenia);
        } catch (Exception e) {
            conectar = null;
            e.printStackTrace();
        }
